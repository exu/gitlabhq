Feature: Project org-mode render
  Background:
  ...
  Scenario: I browse files from master branch
    ...
    And I should see rendered README.org which contains correct links
    And I click on Gitlab API in README.org
    Then I should see correct document rendered

  Scenario: I view README.org in master branch
    Then I should see files from repository in master
    And I should see rendered README.org which contains correct links
    And I click on Rake tasks in README.org
    Then I should see correct directory rendered

  Scenario: I navigate to doc directory to view documentation in master
    And I navigate to the doc/api/README.org
    And I see correct file rendered
    And I click on users in doc/api/README.org
    Then I should see the correct document file

  Scenario: I navigate to doc directory to view user doc in master
    And I navigate to the doc/api/README.org
    And I see correct file rendered
    And I click on raketasks in doc/api/README.org
    Then I should see correct directory rendered
  ...
  Scenario: Tree view should have correct links in README.org
    Given I go directory which contains README.org file
    And I click on a relative link in README.org
