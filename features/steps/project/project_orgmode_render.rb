class Spinach::Features::ProjectOrgmodeRender < Spinach::Features::ProjectMarkdownRender
  ...
  Then 'I should see files from repository in master' do
    ...
    page.should have_content "README.org"
  end

  And 'I should see rendered README.org which contains correct links' do
  ...
  And 'I click on Gitlab API in README.org' do
    click_link "GitLab API doc"
  end

  Then 'I should see correct document rendered' do
    current_path.should == project_blob_path(@project, "master/doc/api/README.org")
    page.should have_content "All API requests require authentication"
  end

  And 'I click on Rake tasks in README.org' do
    click_link "Rake tasks"
  end

  Then 'I should see correct directory rendered' do
    current_path.should == project_tree_path(@project, "master/doc/raketasks")
    page.should have_content "backup_restore.org"
    page.should have_content "maintenance.org"
  end

  And 'I navigate to the doc/api/README.org' do
    click_link "doc"
    click_link "api"
    click_link "README.org"
  end
  ...
  And 'I click on users in doc/api/README.org' do
    click_link "Users"
  end

  Then 'I should see the correct document file' do
    current_path.should == project_blob_path(@project, "master/doc/api/users.org")
    page.should have_content "Get a list of users."
  end

  And 'I click on raketasks in doc/api/README.org' do
    click_link "Rake tasks"
  end
  ...
  And 'I see correct file rendered in markdown branch' do
    current_path.should == project_blob_path(@project, "markdown/doc/api/README.org")
    page.should have_content "Contents"
    page.should have_link "Users"
    page.should have_link "Rake tasks"
  end
  ...
  Then 'I should see the users document file in markdown branch' do
    current_path.should == project_blob_path(@project, "markdown/doc/api/users.org")
    page.should have_content "Get a list of users."
  end
